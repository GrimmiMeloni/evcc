...
Test 3's WARN log is not asserted — the existing test suite never asserts log output, and no log
assertion infrastructure exists. The WARN is a side-effect only.
