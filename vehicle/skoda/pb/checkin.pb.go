...
type AndroidCheckinRequest struct {
	...
	UserSerialNumber *int32                 `protobuf:"varint,30,opt,name=user_serial_number,json=userSerialNumber" json:"user_serial_number,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
const file_checkin_proto_rawDesc = "" +
	...
	"\x02id\x18\x02 \x01(\x03R\x02id\x124\n" +
	...
	"\x12user_serial_number\x18\x1e \x01(\x05R\x10userSerialNumber\"^\n" +
